...
const Add = ({setAddResponseFromHome}) => {
  ...
  const extractYoutubeLink = (userInputYoutubeLink) => {
    ...
    if (userInputYoutubeLink.includes("https://www.youtube.com/watch?v=")) {
      ...
      // Correct usage of backticks for string interpolation
    ...
    <>
      ...
      >
        ...
        <Modal.Body>
         ...
         <Modal.Footer>
          <Button variant="secondary" onClick={handleClose}>             Close           </Button>           <Button onClick={handleUploadVideo} variant="primary">Add</Button>
         </Modal.Footer>
       </Modal>    </>
  );
};
